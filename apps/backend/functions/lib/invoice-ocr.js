...
const FIELD_LABELS = {
  ...
  ΤΥΠΟΣ_ΠΑΡΑΣΤΑΤΙΚΟΥ: 'documentType',
  ΑΚΡΙΒΕΙΑ: 'confidence',
};
...
async function runInvoiceOcrAttempt(pageBuffers) {
  ...
  const systemPrompt = [
    ...
    '',
    '===========================',
    'DOCUMENT TYPE ("ΤΥΠΟΣ_ΠΑΡΑΣΤΑΤΙΚΟΥ")',
    '===========================',
    'Αν το έγγραφο αναγράφει "ΠΙΣΤΩΤΙΚΟ" ή "ΠΙΣΤΩΤΙΚΟ ΤΙΜΟΛΟΓΙΟ", θέσε το "ΤΥΠΟΣ_ΠΑΡΑΣΤΑΤΙΚΟΥ" σε "ΠΙΣΤΩΤΙΚΟ".',
    'Διαφορετικά, θέσε το σε "ΧΡΕΩΣΤΙΚΟ".',
    '',
    '===========================',
